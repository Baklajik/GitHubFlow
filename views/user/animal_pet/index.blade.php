...
@section('content')
    ...
    <section class="content">
        <div class="card">
            ...
            <div class="card-body">
                <a href="{{ route('user.animal_pets.create') }}" class="btn btn-primary mb-3">{{ __('messages.animal_pet.create') }}</a>
...
{{--                                <th>Действия</th>--}}
                            ...
                            @foreach ($animalPets as $animalPet)
                                <tr>
                                    ...
                                    <td>
{{--                                        <a href="{{ route('user.animal_pets.edit', ['animal_pet' => $animalPet->id]) }}" class="btn btn-info btn-sm float-left">--}}
{{--                                            <i class="fas fa-pencil-alt"></i>--}}
{{--                                        </a>--}}
{{--                                        <form action="{{ route('user.animal_pets.destroy', ['animal_pet' => $animalPet->id]) }}" method="post" class="float-left ml-1">--}}
{{--                                            @csrf--}}
{{--                                            @method('DELETE')--}}
